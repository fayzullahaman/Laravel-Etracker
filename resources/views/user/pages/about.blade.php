            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-sm-4">
                            <img class="img-fluid bg-white w-100" src="{{ asset('app-assets/img/about-5.jpg') }}"
                                alt="">
                        </div>
                        <div class="col-sm-8">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-4">
                            <img class="img-fluid bg-white w-100" src="{{ asset('app-assets/img/about-6.jpg') }}"
                                alt="">
                        </div>
                    </div>
                </div>
