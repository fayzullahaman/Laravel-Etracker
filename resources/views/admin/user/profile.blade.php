                ...
                <div class="card">
                    <div class="card-body">
                        <div class="media align-items-center mb-4">
                            <img class="mr-3" src="{{asset('admin/images/avatar/11.png')}}" width="80" height="80" alt="">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="media media-reply">
                            <img class="mr-3 circle-rounded" src="{{asset('admin/images/avatar/2.jpg')}}" width="50" height="50" alt="Generic placeholder image">
                            <div class="media-body">
                                ...
                                <ul>
                                    <li class="d-inline-block"><img class="rounded" width="60" height="60" src="{{asset('admin/images/blog/2.jpg')}}" alt=""></li>
                                    <li class="d-inline-block"><img class="rounded" width="60" height="60" src="{{asset('admin/images/blog/3.jpg')}}" alt=""></li>
                                    <li class="d-inline-block"><img class="rounded" width="60" height="60" src="{{asset('admin/images/blog/4.jpg')}}" alt=""></li>
                                    <li class="d-inline-block"><img class="rounded" width="60" height="60" src="{{asset('admin/images/blog/1.jpg')}}" alt=""></li>
                                </ul>

                                <div class="media mt-3">
                                <img class="mr-3 circle-rounded circle-rounded" src="{{asset('admin/images/avatar/4.jpg')}}" width="50" height="50" alt="Generic placeholder image">
                                <div class="media-body">
                                    <div class="d-sm-flex justify-content-between mb-2">
                                        <h5 class="mb-sm-0">Milan Gbah <small class="text-muted ml-3">about 3 days ago</small></h5>
                                        <div class="media-reply__link">
