        ...
        <div class="container-fluid mt-3">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <div><span><b>Date :</b> {{ \Carbon\Carbon::now()->format('l jS \of F Y h:i:s A') }} </span> ,
                                <b>Time :</b> <span id="clock" onload="currentTime()"></span>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="active-member">
                                <div class="table-responsive">
                                    <table class="table table-xs mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><img src="{{ asset('admin/images/avatar/1.jpg') }}"
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('admin/images/avatar/2.jpg') }}"
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('admin/images/avatar/3.jpg') }}"
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('admin/images/avatar/6.jpg') }}"
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('admin/images/avatar/4.jpg') }}"
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('admin/images/avatar/5.jpg') }}"
                        ...
                        <div class="card-body">
                            ...
                            <div id="activity">
                                <div class="media border-bottom-1 pt-3 pb-3">
                                    <img width="35" src="{{ asset('admin/images/avatar/1.jpg') }}"
                                ...
                                <div class="media border-bottom-1 pt-3 pb-3">
                                    <img width="35" src="{{ asset('admin/images/avatar/2.jpg') }}"
                                        class="mr-3 rounded-circle">
                                    <div class="media-body">
                                ...
                                <div class="media pt-3 pb-3">
                                    <img width="35" src="{{ asset('admin/images/avatar/3.jpg') }}"
                                        class="mr-3 rounded-circle">
                                    <div class="media-body">
